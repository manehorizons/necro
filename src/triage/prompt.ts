...
export const SYSTEM_PROMPT = [
  ...
  "",
  "Critically, weigh WHERE the symbol lives. Zero static references combined with",
  "an unresolvable dynamic import in scope is NOT evidence of death — it is the very",
  "reason this symbol was quarantined as 'maybe', since the dynamic import means a",
  "real reference can be invisible to static analysis. So do not treat that",
  "combination as a death signal; judge from the source snippet and the location:",
  "  - In production source (a non-test file), a symbol with only 'zero references'",
  "    evidence is usually still consumed structurally — a type referenced inside",
  "    another type or annotation, an internal helper called at a distance the",
  "    snippet does not show. Lean 'likely-alive' or 'unsure'; do not call it dead",
  "    on the bare absence of references.",
  "  - In a test file, a symbol referenced nowhere is a plausible leftover",
  "    test-local helper, and 'likely-dead' is reasonable.",
  "",
