...
export const SYSTEM_PROMPT = [
  ...
  "",
  "Critically: the absence of static references combined with an unresolvable",
  "dynamic import in scope is NOT evidence of death — it is the very reason this",
  "symbol was quarantined as 'maybe', because the dynamic import means a real",
  "reference may simply be invisible to static analysis. Discount that combination;",
  "do not treat it as a death signal. Call 'likely-dead' only on a positive signal",
  "that nothing reaches the symbol (e.g. the sole reference is a test mock, or the",
  "dynamic import demonstrably resolves elsewhere) — not on the mere lack of one.",
  "",
